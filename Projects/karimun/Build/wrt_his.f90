...
!
     ...
     &                     GRID(ng) % rmask,                            &
     &                     FORCES(ng) % Pair)
        IF (FoundError(status, nf90_noerr, 1871, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask,                            &
     &                     FORCES(ng) % Uwind)
        IF (FoundError(status, nf90_noerr, 1919, MyFile)) THEN
          IF (Master) THEN
     ...
     &                     GRID(ng) % rmask,                            &
     &                     FORCES(ng) % Vwind)
        IF (FoundError(status, nf90_noerr, 1939, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask_full,                       &
     &                     Vr2d)
        IF (FoundError(status, nf90_noerr, 1997, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask,                            &
     &                     FORCES(ng) % lhflx)
        IF (FoundError(status, nf90_noerr, 2058, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask,                            &
     &                     FORCES(ng) % shflx)
        IF (FoundError(status, nf90_noerr, 2080, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask,                            &
     &                     FORCES(ng) % lrflx)
        IF (FoundError(status, nf90_noerr, 2102, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask,                            &
     &                     FORCES(ng) % evap)
        IF (FoundError(status, nf90_noerr, 2125, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask,                            &
     &                     FORCES(ng) % rain)
        IF (FoundError(status, nf90_noerr, 2147, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask,                            &
     &                     FORCES(ng) % srflx)
        IF (FoundError(status, nf90_noerr, 2194, MyFile)) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask,                            &
     &                     FORCES(ng) % Lwavep)
        IF (FoundError(status, nf90_noerr, 4040, MyFile)) THEN
          IF (Master) THEN
            WRITE (stdout,10) TRIM(Vname(1,idWlen)), HIS(ng)%Rindex
          END IF
          exit_flag=3
