...
export   COAWST_APPLICATION=COUPLING_KARIMUN
...
export   MY_ROOT_DIR=/home/tr16/COAWST_3.7
export   MY_PROJECT_DIR=${MY_ROOT_DIR}/Projects/karimun
...
export   NETCDF_CONFIG=/opt/ohpc/pub/apps/netcdf-4.7.4/bin/nc-config
