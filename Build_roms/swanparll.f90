!
!     SWAN - routines for distributed-memory approach based on 1
!
...
!  3. Method
!
!     Start 1 and initialize some variables
!
...
!     MPI_COMM_RANK    Get rank of processes in 1 communication context
!     MPI_COMM_SIZE    Get number of processes in 1 communication context
!     MPI_INIT         Enroll in 1
...
! 12. Structure
!
!     Start 1 and initialize some common variables in module M_PARALL
!
! 13. Source text
!
      LEVERR = 0
...
!     --- define 1 constants for communication within SWAN
      SWINT  = MPI_INTEGER
      SWREAL = MPI_REAL
      SWMAX  = MPI_MAX
      SWMIN  = MPI_MIN
...
!
!     IERR    :   error value of 1 call
!     PARALMPI:   if true, parallel process is carried out with 1
!
      INTEGER IERR
      LOGICAL PARALMPI
!
...
!
      ...
      IF ( PARALMPI ) THEN
         ...
         IF ( LEVERR.GE.4 ) THEN
!        --- in case of a severe error abort all 1 processes
...
!JAC!  3. Method
!JAC!
!JAC!     Made use of 1 by means of SWSENDNB and SWRECVNB
...
!  3. Method
!
!     Made use of 1 by means of SWSENDNB and SWRECVNB
...
!  3. Method
!
!     Made use of 1 by means of SWGATHER
!
!  4. Argument variables
!
...
!PUN      USE OCPCOMM2, ONLY: LENFNM, DIRCH2                                  41.36
      ...
      USE OUTP_DATA
      USE M_PARALL                                                        40.31
      USE swn_outnc, ONLY: swn_outnc_colspc                               41.40
!PUN      USE SIZES, ONLY: GLOBALDIR, LOCALDIR                                41.36
...
!        --- if it is not open or already open thru another request
         IF ( .NOT.OPENED .OR. NREF.LE.HIOPEN ) THEN
!           --- open generic output file or reset reference number
            IF (NCF .AND. .NOT.OPENED) THEN                               41.40
