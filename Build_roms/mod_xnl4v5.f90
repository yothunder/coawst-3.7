...
!     16/09/2002   Parameter IPROC added to take are of 1
...
integer, intent(in)  ::  iproc         ! Processor number, controls output file for 1
...
!     16/09/2002 Parameter IPROC included to take care of 1 processors
...
integer, intent(in) :: iproc            ! 1 processor number
!
