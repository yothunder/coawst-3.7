      MODULE strings_mod
!
!svn $Id: strings.F 1054 2021-03-06 19:47:12Z arango $
!================================================== Hernan G. Arango ===
...
!    GlobalError   global check execution flag against no-error code   !
!    TaskError     task check execution flag against no-error code     !
