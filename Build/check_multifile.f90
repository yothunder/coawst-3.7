...
!
!svn $Id: check_multifile.F 1054 2021-03-06 19:47:12Z arango $
!================================================== Hernan G. Arango ===
...
!
      ...
      IF (FoundError(exit_flag, NoError, 612, MyFile)) THEN
...
!
      ...
      IF (FoundError(exit_flag, NoError, 714, MyFile)) RETURN
!
