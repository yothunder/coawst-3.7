...
!
!svn $Id: set_contact.F 1054 2021-03-06 19:47:12Z arango $
!================================================== Hernan G. Arango ===
...
!
      ...
      IF (FoundError(exit_flag, NoError, 76, MyFile)) THEN
...
!
     ...
     &                      Linterpolate,                               &
     &                      ncid = NGCid)
      IF (FoundError(exit_flag, NoError, 238, MyFile)) RETURN
!
...
!
     ...
     &                      J_top,                                      &
     &                      ncid = NGCid)
      IF (FoundError(exit_flag, NoError, 297, MyFile)) RETURN
!
...
!
     ...
     &                      contact_region,                             &
     &                      ncid = NGCid)
      IF (FoundError(exit_flag, NoError, 365, MyFile)) RETURN
!
...
!
     ...
     &                      Idg_cp,                                     &
     &                      ncid = NGCid)
      IF (FoundError(exit_flag, NoError, 390, MyFile)) RETURN
...
!
     ...
     &                      Yrg,                                        &
     &                      ncid = NGCid)
      IF (FoundError(exit_flag, NoError, 439, MyFile)) RETURN
!
...
!
     ...
     &                      h,                                          &
     &                      ncid = NGCid)
      IF (FoundError(exit_flag, NoError, 477, MyFile)) RETURN
!
...
!
     ...
     &                      mask,                                       &
     &                      ncid = NGCid)
      IF (FoundError(exit_flag, NoError, 552, MyFile)) RETURN
!
