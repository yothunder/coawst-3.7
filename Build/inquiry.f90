...
!
!svn $Id: inquiry.F 1054 2021-03-06 19:47:12Z arango $
!================================================== Hernan G. Arango ===
...
!
     ...
     &                                    TRIM(Fname)
            exit_flag=4
            IF (FoundError(exit_flag, NoError, 302, MyFile)) RETURN
          END IF
        END IF
...
!
     ...
     &                                   'cannot be determined.'
        ...
        END IF
        exit_flag=2
        IF (FoundError(exit_flag, NoError, 436, MyFile)) RETURN
      END IF
!
...
!
      IF (ncid.eq.-1) THEN
        ...
        IF (FoundError(exit_flag, NoError, 480, MyFile)) THEN
...
!
     ...
     &                            start = (/Trec-1/),                   &
     &                            total = (/1/))
            IF (FoundError(exit_flag, NoError, 554, MyFile)) THEN
