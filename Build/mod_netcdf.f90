     ...
     &                          TRIM(SourceFile), nf90_strerror(status)
        ...
        ELSE
          IF (n_dim.gt.Mdims) THEN
            ...
            ioerror=0
          END IF
          IF (FoundError(status, nf90_noerr, 364, MyFile)) THEN
     ...
     &                            nf90_strerror(status)
        ...
        ELSE
          IF (n_var.gt.Mvars) THEN
            ...
            exit_flag=2
          END IF
          IF (FoundError(status, nf90_noerr, 1502, MyFile)) THEN
...
!
     ...
     &                                      var_Dname(i), var_Dsize(i))
              IF (FoundError(status, nf90_noerr, 1587, MyFile)) THEN
...
!
      ...
      character (len=*), parameter :: MyFile =                          &
     &  "ROMS/Modules/mod_netcdf.F"//", netcdf_get_fatt"
!
!-----------------------------------------------------------------------
!  Inquire ID of requested variable.
!-----------------------------------------------------------------------
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 2507, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 2534, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=2
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 3014, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 3041, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=2
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 3280, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 3521, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
     ...
     &                                 xtype = my_type)
          IF (status.eq.nf90_noerr) THEN
            ...
            ELSE IF (my_type.eq.nf90_char) THEN
              ...
              END IF
            END IF
            IF (FoundError(status, nf90_noerr, 3561, MyFile)) THEN
              WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),          &
     &                          TRIM(SourceFile), nf90_strerror(status)
              exit_flag=2
              ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 3695, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
     ...
     &                                 xtype = my_type)
          IF (status.eq.nf90_noerr) THEN
            ...
            ELSE IF (my_type.eq.nf90_char) THEN
              ...
              END IF
            END IF
            IF (FoundError(status, nf90_noerr, 3738, MyFile)) THEN
              WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),          &
     &                          TRIM(SourceFile), nf90_strerror(status)
              exit_flag=2
              ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 3867, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 3883, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=2
            ioerror=status
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 4017, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=2
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 4137, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 4152, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=2
            ioerror=status
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 4295, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=2
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 4419, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 4434, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=2
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 4558, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 4573, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=2
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 4697, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 4863, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 5160, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 5175, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=2
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        ...
        IF (FoundError(exit_flag, NoError, 5835, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          END IF
          IF (FoundError(status, nf90_noerr, 5864, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 5974, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 5984, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          IF (FoundError(status, nf90_noerr, 5998, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 6108, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 6118, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 6132, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 6242, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 6252, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 6266, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 6376, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 6386, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 6400, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 6512, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 6522, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          ELSE
            ...
            status=nf90_put_var(my_ncid, my_varid, my_A, start, total)
          END IF
          IF (FoundError(status, nf90_noerr, 6541, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 6651, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 6661, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 6675, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 6785, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 6795, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 6809, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 6925, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 6935, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          END IF
          IF (FoundError(status, nf90_noerr, 6963, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 7078, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 7088, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          IF (FoundError(status, nf90_noerr, 7113, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 7228, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 7238, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, AI, start, total)
          IF (FoundError(status, nf90_noerr, 7265, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 7385, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 7395, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 7531, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 7541, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 7555, MyFile)) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 7675, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 7685, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 7819, MyFile)) RETURN
      ELSE
        my_ncid=ncid
      END IF
!
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 7829, MyFile)) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile), nf90_strerror(status)
            exit_flag=3
            ioerror=status
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          IF (FoundError(status, nf90_noerr, 8013, MyFile)) THEN
...
!
      ...
      IF (OutThread) THEN
        ...
        IF (FoundError(status, nf90_noerr, 8146, MyFile)) THEN
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          IF (FoundError(status, nf90_noerr, 8164, MyFile)) THEN
...
!
      IF (OutThread) THEN
        ...
        IF (FoundError(status, nf90_noerr, 8255, MyFile)) THEN
      ...
      IF (InpThread) THEN
        SELECT CASE (omode)
          ...
          CASE DEFAULT
            ...
            status=nf90_open(TRIM(ncname), my_omode, ncid)
        END SELECT
        IF (FoundError(status, nf90_noerr, 8398, MyFile)) THEN
          WRITE (stdout,10) TRIM(ncname), TRIM(SourceFile),             &
     &                      nf90_strerror(status)
          exit_flag=3
          ioerror=status
...
!
      IF (OutThread) THEN
        ...
        IF (FoundError(status, nf90_noerr, 8489, MyFile)) THEN
          IF (Master) WRITE (stdout,10) TRIM(ncname), TRIM(SourceFile), &
     &                                  nf90_strerror(status)
          exit_flag=3
          ioerror=status
...
!
      IF (OutThread) THEN
        ...
        IF (FoundError(status, nf90_noerr, 8567, MyFile)) THEN
          WRITE (stdout,10) TRIM(ncname), TRIM(SourceFile),             &
     &                      nf90_strerror(status)
          exit_flag=3
          ioerror=status
